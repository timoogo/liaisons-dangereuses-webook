...
class OfficerRepository extends ServiceEntityRepository
{
     ...
     */
    public function add(Officer $entity, bool $flush = true): void
    {
     ...
     * @throws OptimisticLockException
     */
    public function remove(Officer $entity, bool $flush = true): void
    {
    ...
    // /**
    //  * @return Officer[] Returns an array of Officer objects
    //  */
    /*
    ...
    */
    ...
    /*
    public function findOneBySomeField($value): ?Officer
    {
        return $this->createQueryBuilder('o')
            ->andWhere('o.exampleField = :val')
            ->setParameter('val', $value)
